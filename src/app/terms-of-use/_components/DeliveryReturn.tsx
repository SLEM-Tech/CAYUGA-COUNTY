	...
	return (
		<div className='text-[#667085]'>
			...
			<div className='mb-6'>
				...
				<ul className='list-disc pl-5 space-y-1 text-xs md:text-sm xl:text-base'>
					<li>
						Cayuga County Services Limited is not responsible for any damages
						caused after delivery
					</li>
					<li>
						Cayuga County Services Limited bears no responsibility for goods
						signed by an alternative person
					</li>
					<li>
