	...
	return (
		<>
			...
			>
							...
							>
								{typeof window !== "undefined" && (
									<div className='flex relative justify-center items-center rounded-full w-12 h-12 p-2 text-sm'>
										...
										<FaCartArrowDown className='text-3xl text-primaryColor-400' />
									</div>
								)}
				...
				{/* Mobile */}
				<div className='flex flex-col items-center w-full slg:hidden py-2.5 px-2 xs:px-4'>
				...
				{isExpanded && (
					<div className='fixed inset-0 bg-black/50 backdrop-blur-sm z-40 flex justify-center items-start pt-20'>
						<div
							ref={searchRef}
							className='relative flex justify-center items-centerl w-[95%] lg:w-[60%] max-w-2xl lg:h-fit bg-white rounded-full border-2 border-primaryColor-400 shadow-lg'
						>
							<input
								ref={inputRef}
								type='text'
							...
							{isSearchLoading ? (
								<button
									type='button'
									className='flex items-center justify-center size-12 text-white bg-primaryColor-400 rounded-r-full'
									disabled
								>
								...
								<button
									type='button'
									className='flex items-center justify-center size-12 text-white bg-primaryColor-400 rounded-r-full hover:bg-primaryColor-400/90 transition-colors'
									onClick={handleSearchClick}
								>
									<FiSearch />
								</button>
